...
urlpatterns = [
    ...
    path('admin-leave',views.admin_leave_view,name='admin-leave'),
    ...
    path('teacher-apply-leave',views.teacher_apply_leave_view,name='teacher-apply-leave'),
    path('teacher-apply-leave-save',views.teacher_apply_leave_save_view,name='teacher-apply-leave-save'),

    path('student-dashboard', views.student_dashboard_view,name='student-dashboard'),
    path('student-attendance', views.student_attendance_view,name='student-attendance'),
    path('student-leave',views.student_apply_leave_view,name='student-leave'),
